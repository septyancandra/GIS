...
//auth Junis 2017-04-26
class M_user extends CI_Model{        

    var $table = 'jajalquery.user';
    var $column_order = array('id','username','nama'); //set column field database for datatable orderable
	...
	private function _get_datatables_query()
    {
        ...
        foreach ($this->column_search as $item) // loop column 
        {
            ...
            if($cari) // if datatable send POST for search
            {                 				
                if($i===0) // first loop
                {				
